...
{
    public class cst_MarkToMarketFull  : ViewClass
    {
        ...
        public cst_MarkToMarketFull(ViewForm view) : base(view) { }
        #endregion
        
        /* Mark To Market Full - Initialize Class
        Mark To Market Full - EVE - Initialize Class */
