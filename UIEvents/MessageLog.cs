...
{
    public class MessageLogCE  : UiClassEvent
    {
        ...
        {
            _view.DataSource.Tables["message"].ExtendedProperties.Remove("From Archive");
            if (ToolbarHelper.CheckStateButton(_view, "From Archive"))
            {
                _view.DataSource.Tables["message"].ExtendedProperties["From Archive"] = "message";
            }
