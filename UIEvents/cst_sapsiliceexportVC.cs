...
{
    public class cst_sapsiliceexport  : ViewClass
    {
        ...
        public cst_sapsiliceexport(ViewForm view) : base(view) { }
        #endregion
        
        /* SAP Silice Export - Initialize Class
        SAP Silice Export - DEV - Initialize Class */
