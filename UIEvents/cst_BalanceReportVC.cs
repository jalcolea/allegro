...
{
    public class cst_BalanceReport  : ViewClass
    {
        ...
        public cst_BalanceReport(ViewForm view) : base(view) { }
        #endregion
        
        /* BalanceReport - Initialize Class
        Balance Report  - EVE - Initialize Class */
