...
{
    public class cst_DistributionDoc  : ViewClass
    {
        ...
        public cst_DistributionDoc(ViewForm view) : base(view) { }
        #endregion
        
        /* Distribution Doc - Initialize Class
        Trade - Trade Execution - Distribution Document - Initialize Class */
