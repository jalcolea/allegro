...
{
    public class cst_GlobalerisImport  : ViewClass
    {
        ...
        public cst_GlobalerisImport(ViewForm view) : base(view) { }
        #endregion
        
        /* Globaleris Import - Initialize Class
        Globaleris Export - DEV - Initialize Class */
