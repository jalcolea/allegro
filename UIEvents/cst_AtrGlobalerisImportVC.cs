...
{
    public class cst_AtrGlobalerisImport  : ViewClass
    {
        ...
        public cst_AtrGlobalerisImport(ViewForm view) : base(view) { }
        #endregion
        
        /* Atr Globaleris Import - Initialize Class
        Atr Globaleris Import - DEV - Initialize Class */
