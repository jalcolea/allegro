...
{
    public class cst_EOMReportCE  : UiClassEvent
    {
        ...
        /* EOM Report - Init View
        EOM Report - DEV - Init View */
        public UiEventResult InitView_1()
        {
            return new UiEventResult(EventStatus.Continue);
        }
        /* EOM Report - Export Excel
        EOM Report - DEV - Logic for toolclick button for export excel file */
